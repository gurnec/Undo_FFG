...
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "2.0"
...
Section
    ...
    WriteRegStr   HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Undo for MoM2e" "DisplayVersion" "2.0"
